package com.ajmpcode.backend.apirest.controllers;
...
import com.ajmpcode.backend.apirest.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> update(@Validated @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id
		...
		try {
			...
			response.put("mensaje", "Error al realizar la modificación en la base de datos");
			response.put("error", e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage()));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
